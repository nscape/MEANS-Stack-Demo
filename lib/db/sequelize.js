...
var sequelize = new Sequelize(
  dbConfig[process.env.NODE_ENV].pg.database, 
  dbConfig[process.env.NODE_ENV].pg.user,  
  dbConfig[process.env.NODE_ENV].pg.password,  {

  port: dbConfig[process.env.NODE_ENV].pg.port,
